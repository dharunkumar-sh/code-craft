...
import { CircleOff, Cloud, Laptop, Moon, MoonStar, Palette, Sun } from "lucide-react";
import { AnimatePresence, motion } from "framer-motion";

const THEME_ICONS: Record<string, React.ReactNode> = {
  "vs-dark": <Moon className="size-4" />,
  "vs-light": <Sun className="size-4" />,
  "github-dark": <MoonStar className="size-4" />,
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-46 group relative flex items-center gap-2 px-3 h-10 bg-[#1e1e2e]/80 hover:bg-[#262637] 
