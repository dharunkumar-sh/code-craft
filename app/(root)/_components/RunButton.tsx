...
const RunButton = () => {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className={`
      group relative inline-flex items-center justify-center gap-2 w-31 px-3 h-10 rounded-lg
      disabled:cursor-not-allowed focus:outline-none border border-transparent
